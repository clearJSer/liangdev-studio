  ...
  return (
    <div className={styles.productCore} aria-hidden="true">
      ...
      <span className={styles.corePrism}>
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeTopFront}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeTopBack}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeTopLeft}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeTopRight}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeBottomFront}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeBottomBack}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeBottomLeft}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeBottomRight}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeVerticalFrontLeft}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeVerticalFrontRight}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeVerticalBackLeft}`} />
        <span className={`${styles.cubeEdge} ${styles.cubeEdgeVerticalBackRight}`} />
        <span className={`${styles.cubeVertex} ${styles.cubeVertexFrontTopLeft}`} />
        <span className={`${styles.cubeVertex} ${styles.cubeVertexFrontTopRight}`} />
        <span className={`${styles.cubeVertex} ${styles.cubeVertexFrontBottomLeft}`} />
        <span className={`${styles.cubeVertex} ${styles.cubeVertexFrontBottomRight}`} />
        <span className={`${styles.cubeVertex} ${styles.cubeVertexBackTopLeft}`} />
        <span className={`${styles.cubeVertex} ${styles.cubeVertexBackTopRight}`} />
        <span className={`${styles.cubeVertex} ${styles.cubeVertexBackBottomLeft}`} />
        <span className={`${styles.cubeVertex} ${styles.cubeVertexBackBottomRight}`} />
      </span>
